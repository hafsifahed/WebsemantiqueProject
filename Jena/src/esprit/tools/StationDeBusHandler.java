...
public class StationDeBusHandler implements HttpHandler {
    ...
    public StationDeBusHandler(String fusekiEndpoint) {
    ...
    // GET method to retrieve bus stations
    ...
    // POST method to create a new bus station
    private void handlePost(HttpExchange exchange) throws IOException {
        ...
        try {
            ...
            sendResponse(exchange, createResponse("Bus Station created: " + nomStation), 201);
        } catch (IOException e) {
            sendResponse(exchange, createResponse("Failed to create bus station: " + e.getMessage()), 500);
        }
    }

    // PUT method to update an existing bus station
    private void handlePut(HttpExchange exchange) throws IOException {
        ...
        try {
            ...
            sendResponse(exchange, createResponse("Bus Station updated: " + nomStation), 200);
        } catch (IOException e) {
            sendResponse(exchange, createResponse("Failed to update bus station: "+ e.getMessage()), 500);
        }
    }

    // DELETE method to remove a bus station
    private void handleDelete(HttpExchange exchange) throws IOException {
        ...
        try {
            ...
            sendResponse(exchange, createResponse("Bus Station deleted"), 200);
        } catch (IOException e) {
            sendResponse(exchange, createResponse("Failed to delete bus station: "+ e.getMessage()), 500);
        }
    }
